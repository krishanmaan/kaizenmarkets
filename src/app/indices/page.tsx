      ...
      <div className="container mx-auto py-12 px-4 max-w-screen-xl">
        <div className="grid grid-cols-1 gap-6 text-center">
          <div className="mb-12 pt-16">
            <h2 className="text-4xl sm:text-5xl font-Poppins">
              Advantages of Spot Trading with <br /> 
              <span className="text-yellow-500 font-Poppins font-extrabold">Kaizen Markets</span>
            </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 text-white font-Poppins">
          <div className="p-6 sm:p-8 bg-purple-600 shadow-md rounded-lg flex flex-col justify-center items-center text-center hover:bg-[#F7F6F9] hover:text-black transition duration-200">
