                        ...
                        <div>
                            <ul className="grid grid-cols-1 md:grid-cols-3 gap-1 text-black text-sm w-full pt-12">
                                <li className="inline-flex bg-[#FFFFFF] p-2 rounded-lg  items-center hover:bg-green-600 hover:text-white">
                                    <img src={employee.src} alt="Personal Account Managers" width={50} height={50} />
                                    <span className="ml-2 text-center">Personal Account Managers</span>
                                </li>
                                <li className="inline-flex bg-[#FFFFFF] p-2 rounded-lg  items-center hover:bg-green-600 hover:text-white">
                                    <img src={chart.src} alt="Forex Market Research" width={50} height={50} />
                                    <span className="ml-2 text-center">Free  Forex Market Research</span>
                                </li>
                                <li className="inline-flex bg-[#FFFFFF] p-2 rounded-lg  items-center hover:bg-green-600 hover:text-white">
                                    <img src={videoTutorial.src} alt="Daily Forex Webinars" width={50} height={50} />
                                    <span className="ml-2 text-center">Free Access to Daily Forex Webinars</span>
                                </li>
                                <li className="inline-flex bg-[#FFFFFF] p-2 rounded-lg  items-center hover:bg-green-600 hover:text-white">
                                    <img src={videoPlayer.src} alt="Unlimited Video Tutorials" width={50} height={50} />
                                    <span className="ml-2 text-center">Unlimited Access to Video Tutorials</span>
                                </li>
                                <li className="inline-flex bg-[#FFFFFF] p-2 rounded-lg  items-center hover:bg-green-600 hover:text-white">
                                    <img src={antenna.src} alt="Forex Trading Signals" width={50} height={50} />
                                    <span className="ml-2 text-center">Daily Access to Forex Trading Signals</span>
                                </li>
                                <li className="inline-flex bg-[#FFFFFF] p-2 rounded-lg  items-center hover:bg-green-600 hover:text-white">
                                    <img src={pieChart.src} alt="Daily Technical Analysis" width={50} height={50} />
                                    <span className="ml-2 text-center">Daily Technical Analysis</span>
                                </li>
                                <li className="inline-flex bg-[#FFFFFF] p-2 rounded-lg  items-center hover:bg-green-600 hover:text-white">
                                    <img src={calendar.src} alt="Forex Market Outlook" width={50} height={50} />
                                    <span className="ml-2 text-center">Daily Forex Market Outlook</span>
                                </li>
                                <li className="inline-flex bg-[#FFFFFF] p-2 rounded-lg  items-center hover:bg-green-600 hover:text-white">
                                    <img src={responsive.src} alt="Platforms to Choose" width={50} height={50} />
                                    <span className="ml-2 text-center">16 Platforms to Choose Any Device, Anywhere</span>
                                </li>
                                <li className="inline-flex bg-[#FFFFFF] p-2 rounded-lg  items-center hover:bg-green-600 hover:text-white">
                                    <img src={support.src} alt="24/5 Live Help" width={50} height={50} />
