    ...
    <div className="container mx-auto py-12 px-4 max-w-screen-xl">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          <div className="p-8 bg-[#F7F6F9] shadow-md rounded-lg flex flex-col justify-center items-center text-center hover:bg-purple-600 hover:text-white transition duration-200">
            <FaBitcoin className="text-3xl text-yellow-500 mb-4" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="p-8 bg-[#F7F6F9] shadow-md rounded-lg flex flex-col justify-center items-center text-center hover:bg-purple-600 hover:text-white transition duration-200">
          <FaBox className="text-3xl text-yellow-500 mb-4" />
        ...
        <div className="p-8 bg-[#F7F6F9] shadow-md rounded-lg flex flex-col justify-center items-center text-center hover:bg-purple-600 hover:text-white transition duration-200">
          <FaIndustry className="text-3xl text-yellow-500 mb-4" />
