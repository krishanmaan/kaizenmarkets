        ...
        <section className="  flex items-center justify-center">
            <div className='max-w-screen-xl grid grid-cols-1 md:grid-cols-2 items-center gap-8'>
                ...
                <div className="px-4 lg:py-40 sm:px-6 lg:px-8">
                    <h2 className="text-4xl font-bold text-gray-900 mb-4 font-Inter18">Trade With Even  <samp className='text-[#FE7501]'>Lower</samp> Costs</h2>
                    <p className=" text-gray-600 mb-6 font-Inter18">With our RAW ECN account, traders can experience some of the lowest trading costs in the industry. We fully understand the importance of keeping trading costs to a minimum, so you can realize greater profit.</p>
