    ...
    <div className="w-full">
      <div className="bg-gradient-custom2 pt-24 text-justify">
        ...
        <div className="p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between max-w-screen-lg mx-auto">
          <div>
            <h1 className="text-gray-900 text-4xl sm:text-4xl font-bold ">Forex</h1>
      ...
      <div className="bg-cover bg-center bg-gray-900 pt-20 pb-20 flex flex-col items-center justify-center -mb-16 ">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 p-6  gap-6  max-w-screen-xl mx-auto">
          {[
